...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if(self.controllerStudent != nil && self.controllerStudent.flagSave){
        ...
        student.averageScoreString = self.controllerStudent.averageScore;
        self.university.grupsSortByStudentName = [self.university sortGrupsByNameStudent:self.university.grupsBasic];
        self.university.grupsSeparatedByAverageAndSortbyName = [self.university sortGrupsByAverageScoreAndNameStudent:self.university.grupsBasic];
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem*editButton = [[UIBarButtonItem alloc]initWithTitle:@"EditForBasic" style:UIBarButtonItemStylePlain target:self action:@selector(editActionBegin:)];
...
-(void)enableGrupsBasic:(UIBarButtonItem*)sender{
    ...
    [self.university setGrupBasic:self.university.grupsBasicCopy];
     self.editButton.title = @"EditForBasic";
    [self.table reloadData];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vcStudentCart.name = student.firstName;
    vcStudentCart.familyName = student.lastName;
    vcStudentCart.averageScore = student.averageScoreString;
